...
const ProductText = () => {
    return (
      ...
      <Row>
        <Col md="8">
          <div className="cat-title d-inline">
            ...
            تايم (برودكت) أحمر <div className="cat-rate d-inline mx-3">4.5 <AiFillStar className='stare text-warning'/></div>
          </div>
        </Col>
      </Row>
      <Row>
      ...
      <Row className="mt-4">
        <Col md="12">
          <div className="btn btn-outline-dark disabled">34000 جنية</div>
          <div className="btn btn-dark mx-3">اضف للعربة</div>
        </Col>
      </Row>
    </div>
    )
